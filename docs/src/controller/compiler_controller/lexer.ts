...
module NightingaleCompiler {
    export class Lexer {
        ...
        * @param {string} sourceCode source code from CodeMirror input field.
         */
        public main(sourceCode: string): string {
            this.output.push(new OutputConsoleMessage(LEXER, INFO, `Lexing program ${this.programNumber}...`));
            ...
            LoopThroughSourceCodeWhileLoop: while (this._last_position <= sourceCode.length && this._current_position <= sourceCode.length) {
                ...
                // In string
                    ...
                    // Quotation found in string
                        ...
                        this.emit_token_to_stream(new LexicalToken("END_STRING_EXPRESSION", null, current_potential_lexeme, this._code_editor_line_number, this._code_editor_line_position + 1));
                    ...
                    // Not a valid character
                        ...
                        this.emit_token_to_stream(new LexicalToken(INVALID_TOKEN, null, current_potential_lexeme, this._code_editor_line_number, this._code_editor_line_position + 1));
                        this._code_editor_line_position += current_potential_lexeme.length;
                        this.advance_last_position();
                    }// else
                }// else-if
                ...
                // Not in comment nor in a string
                     ...
                     */
                        ...
                        if (token.name.includes("SPACE_TAB")) {
                            this.emit_token_to_stream(token.copyWith(
                                current_potential_lexeme,
                                this._code_editor_line_number,
         ...
         */
        private post_check_for_warnings(newSourceCode: string): string {
            // Missing EOP, add it
        ...
        private emit_token_to_stream(newToken: LexicalToken): void {
            if (newToken.name == WARNING_TOKEN) {
                ...
                this.output.push(new OutputConsoleMessage(LEXER, ERROR, `${this._code_editor_line_number}:${this._code_editor_line_position} Unrecognized Token: ${newToken.lexeme}`));
