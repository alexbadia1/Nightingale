...
(function (NightingaleCompiler) {
    class DebugConsoleModel {
        constructor(debugTokens, heartFaceEmojii = `<svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="green" class="bi bi-play-fill" viewBox="0 0 16 16">
