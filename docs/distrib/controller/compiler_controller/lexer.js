...
(function (NightingaleCompiler) {
    class Lexer {
        ...
        * @param {string} sourceCode formatted source code from CodeMirror input field.
            ...
            LoopThroughSourceCodeWhileLoop: while (this.lastPosition <= sourceCode.length && this.currentPosition <= sourceCode.length) {
                ...
                // In string
                    ...
                    // Quotation found in string
                        ...
                        this.emit_token_to_stream(new NightingaleCompiler.LexicalToken("END_STRING_EXPRESSION", null, current_potential_lexeme, this.lineNumber, this.linePosition));
                    ...
                    // Not a valid character
                        ...
                        this.emit_token_to_stream(new NightingaleCompiler.LexicalToken(INVALID_TOKEN, null, current_potential_lexeme, this.lineNumber, this.linePosition));
                        this.linePosition += current_potential_lexeme.length;
                        this.advance_last_position();
                    } // else
                } // else-if
                // Not in comment nor in a string
                     ...
                     */
                        ...
                        if (token.name.includes("SPACE_TAB")) {
                            this.tempToken = token.copyWith(current_potential_lexeme, this.lineNumber, this.linePosition);
                        } // if
                        else {
        ...
        mapEndOfProgramToMethod(new_current_token, new_current_potential_lexeme) {
         ...
         */
        calculate_current_token_line_position(new_token_lexeme) {
