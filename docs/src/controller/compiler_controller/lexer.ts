        ...
        * @param {string} sourceCode formatted source code from CodeMirror input field.
            ...
            LoopThroughSourceCodeWhileLoop: while (this.lastPosition <= sourceCode.length && this.currentPosition <= sourceCode.length) {
                ...
                // In string
                    ...
                    // No line breaks in strings
                        ...
                        // Error
                        this.emit_token_to_stream(new LexicalToken(INVALID_TOKEN, null, "EOL", this.lineNumber, this.linePosition));
                        this.linePosition += current_potential_lexeme.length;
                        this.advance_last_position();
                    ...
                    // Quotation found in string
                        ...
                        this.emit_token_to_stream(new LexicalToken("END_STRING_EXPRESSION", null, current_potential_lexeme, this.lineNumber, this.linePosition + 1));
                    ...
                    // Not a valid character
                        ...
                        this.emit_token_to_stream(new LexicalToken(INVALID_TOKEN, null, current_potential_lexeme, this.lineNumber, this.linePosition + 1));
                        this.linePosition += current_potential_lexeme.length;
                        this.advance_last_position();
                    }// else
                }// else-if
        ...
        private check_illegal_characters_for_symbols(new_current_potential_lexeme: string, source_code: string) {
            if (/(^!$|^\*$|^\/$)/.test(new_current_potential_lexeme)) {
                ...
                if (current_token == null) {
                    this.emit_token_to_stream(new LexicalToken(INVALID_TOKEN, null, new_current_potential_lexeme, this.lineNumber, this.linePosition));
                    this.advance_last_position();
                }// if
            ...
            // Not a special illegal character.
                ...
                if (new_current_potential_lexeme.length == 1) {
                    this.emit_token_to_stream(new LexicalToken(INVALID_TOKEN, null, new_current_potential_lexeme, this.lineNumber, this.lastPosition));
                    this.advance_last_position();
                }
                else {
                    this.currentPosition++;
        ...
        private post_check_for_warnings(newSourceCode: string): string {
            ...
            if (this.missingEndOfProgram) {
                ...
                this.emit_token_to_stream(new LexicalToken(MISSING_TOKEN, null, "$", this.lineNumber, -1));
